...
const STRINGS = {
  en: {
    ...
    'doc.privacy.s3.body': 'Any host that serves the website (for example Netlify) logs basic HTTP requests: IP address, time, browser. That is normal for every website and is unrelated to the contents of your optimization files.',
  ...
  es: {
    ...
    'lp.compare.after.selected.why': 'Centro de meseta · maximin · no el pico de beneficio',
    ...
    'lp.avoid.2.body': 'Orometra puntúa por el peor periodo y por vecindades maximin — no por una media que esconde un borde frágil.',
    'lp.avoid.3.title': 'Confundir evidencia con un GO',
    'lp.avoid.3.body': 'Un grado sólido significa que los datos sostienen una región estable. No es permiso para operar ni un pronóstico de beneficio futuro.',
    'lp.how.kicker': 'Flujo',
    ...
    'lp.foot.tagline': 'Mesetas antes que cimas. El análisis se queda en tu navegador.',
    ...
    'doc.method.s3.body': 'Las configuraciones vecinas se comparan en pasos de parámetro. Una meseta es una región conexa donde el cuartil bajo del entorno se mantiene bueno y casi todas las vecinas pasan tus mínimos. El representante se elige por maximin: el punto cuyo peor vecino es el mejor posible — el centro de la cresta, no la cima.',
    'doc.method.s4.title': '4. Fuerza de la evidencia, no GO / NO-GO',
    ...
    'doc.privacy.s3.body': 'Cualquier proveedor que sirva la web (por ejemplo Netlify) registra peticiones HTTP básicas: IP, hora, navegador. Es normal en cualquier sitio y no está relacionado con el contenido de tus archivos de optimización.',
