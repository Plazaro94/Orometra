...
const STRINGS = {
  en: {
    ...
    'doc.method.s5.title': '5. What we do not claim',
    'doc.method.s5.1': 'A plateau is stability in your sample — not proof of future edge.',
    'doc.method.s5.2': 'We do not invent classic PBO / Reality Check / SPA: MT5 optimization files lack the equity curves those tests need.',
    'doc.method.s5.3': 'Forward already helps select, so it is slightly “contaminated”; the cleanest check is a true unseen period.',
    'doc.method.s5.4': 'We do not tell you to buy, sell, or fund an EA. Evidence ≠ permission to trade.',
  ...
  es: {
    ...
    'doc.method.s5.title': '5. Lo que no afirmamos',
    'doc.method.s5.1': 'Una meseta es estabilidad en tu muestra — no prueba de ventaja futura.',
    'doc.method.s5.2': 'No inventamos PBO / Reality Check / SPA clásicos: el export de MT5 no trae las curvas de equity que esos tests necesitan.',
    'doc.method.s5.3': 'El forward ya ayuda a seleccionar, así que está algo «contaminado»; lo más limpio es un periodo de verdad no visto.',
    'doc.method.s5.4': 'No te decimos que compres, vendas o financiés un EA. Evidencia ≠ permiso para operar.',
